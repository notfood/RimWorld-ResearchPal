...
namespace FluffyResearchTree
{
  public static class ResourceBank
  {
        public static class String {
            ...
            public static readonly string ShouldSeparateByTechLevels = "Fluffy.ResearchTree.ShouldSeparateByTechLevels".Translate();
            public static readonly string ShouldSeparateByTechLevelsTip = "Fluffy.ResearchTree.ShouldSeparateByTechLevelsTip".Translate();
